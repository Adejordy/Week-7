...
//FIXME /* I'm not sure how to find the average age/ coming back to this part of the question:
...
//Answer: by using arrayname.pop(),
let arrayLength = ["First", "Middle", "Last"];
{
  console.log(arrayLength.pop());
}
//4. How do you access the first element of any array?
//Answer: arrayname.shift
arrayLength = ["First", "Middle", "Last"];
{
  console.log(arrayLength.shift());
}
...
//TODO 13. Create a function of your own that solves a problem. In comments, write what the function does and why you created it.
